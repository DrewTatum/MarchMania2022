...
class TeamSimulation(TS.ncaa_team_stats):
    ...
    def run_sim(self, team1, team2, team1_pace_mean, team1_pace_std, team2_pace_mean, team2_pace_std, team1_turnover_rate, team1_2shot_percent,
        ...
        # Simulation 
        self.game_tracker = basketball_sim(self.team1, self.team2, mean_poss, std_poss, self.n_simulations, home_turnover_rate, home_two_shot_perc, home_three_shot_perc, home_ft_perc, home_three_shot_prob, 
                                           home_offense_rb_rate, home_ft_per_fg, away_turnover_rate, away_two_shot_perc, away_three_shot_perc, away_ft_perc, away_three_shot_prob, away_offense_rb_rate, away_ft_per_fg)
...
@jit(nopython=True)
def basketball_sim(team1, team2, mean_poss, std_poss, n_simulations, home_turnover_rate, home_two_shot_perc, home_three_shot_perc, home_ft_perc, home_three_shot_prob, home_offense_rb_rate, home_ft_per_fg,
                   away_turnover_rate, away_two_shot_perc, away_three_shot_perc, away_ft_perc, away_three_shot_prob, away_offense_rb_rate, away_ft_per_fg):
    ### Team Stat Values
    ...
    for game in range(game_tracker.shape[0]):
        ...
        while poss_left > 0:
            ...
            if (poss_left*3 + away_score) < home_score:  # The away team can't catch up (Only since care about win probability not score)
                poss_left = 0
